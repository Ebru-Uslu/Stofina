// CLEAN CODE: Scheduled Order Section Component
// Single Responsibility: Handle scheduled order UI logic
    ...
    <>
      ...
      <div className={styles.checkboxContainer}>
        <label className={styles.checkboxLabel}>
          ...
          />
          <span className={styles.checkboxText}>Zamansal Emir</span>
        </label>
      </div>
        ...
        <div className={styles.smartSelectionContainer}>
          ...
          <div className={styles.quickOptionsContainer}>
            {SMART_QUICK_OPTIONS.map((option) => {
              ...
              const displayTime = isValid ? formatQuickOptionTime(option.calculateTime) : 'Geçersiz';
              ...
              return (
                <label key={option.id} className={`${styles.quickOptionLabel} ${!isValid ? styles.disabled : ''}`}>
                  ...
                  <span className={styles.quickOptionText}>
                    {option.label} <span className={styles.quickOptionTime}>({displayTime})</span>
                  </span>
                </label>
              );
            })}
            ...
            <label className={styles.quickOptionLabel}>
              <input
                ...
                className={styles.quickOptionRadio}
              />
              <span className={styles.quickOptionText}>Özel:</span>
